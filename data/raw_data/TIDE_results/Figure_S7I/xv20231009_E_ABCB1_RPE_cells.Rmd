...
```{r}
ref.file <- "xv20231009_ABCB1_RPE1.txt"
output.file <- "xv20231009_E_ABCB1_RPE_cells.pdf"
folder <- ""
seqstart = 100
seqend = 500
maxshift = 10
...
mut_list
write.csv(mut_list_b, file = "xv20231009_RPE1_new_cells_test.csv")
...
cell_levels <- c("K562","DEF","PRO","RPE1")
# Based on TIF
pdf(file = "/Users/x.vergara.ucin/surfdrive/Shared/surfdrive_shared_steensel/writing_spree/draft_DSB_CRISPR_screen/short_version/Figures/source_figures/Supplementary_figures/Figure_S6/xv20231009_LBR2_TIDE_other_cell_lines.pdf", width = 3, height = 5)
ggplot(repair_measurement,aes(fct_relevel(cell_line, cell_levels), editing_freq)) + 
  stat_summary(geom= "col", position = position_dodge2(preserve = "single")) + 
  ggbeeswarm::geom_quasirandom() +
  theme_bw() +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5), legend.position = "top") + ylim(c(0,1)) + 
  labs(fill = "Condition") +
  xlab("Cell line") + 
