...
ggplot(both.screen.gene.value) + 
  ...
  stat_cor(data = subset(both.screen.gene.value, abs(comb.data) > 1.95), aes(R1,R2), method = "spearman", label.y = 20, label.x = -10, cor.coef.name = "rho")

ggplot(both.screen.gene.value) + 
  geom_point(aes(R1,R3, color = library,alpha = abs(comb.data) > 1.95)) + 
  theme_bw() + 
  coord_fixed(ylim = c(-10,25), xlim = c(-10,25)) + ylab("R3 (z-score)") + xlab("R1 (z-score)") +
  theme(legend.position = "none") +
  stat_cor(data = subset(both.screen.gene.value, abs(comb.data) > 1.95), aes(R1,R3), method = "spearman", label.y = 20, label.x = -10, cor.coef.name = "rho")

ggplot(both.screen.gene.value) + 
  geom_point(aes(R2,R3, color = library,alpha = abs(comb.data) > 1.95)) + 
  theme_bw() + 
  coord_fixed(ylim = c(-10,25), xlim = c(-10,25)) + 
  ylab("R2 (z-score)") + xlab("R3 (z-score)") +
  theme(legend.position = "none") +
  stat_cor(data = subset(both.screen.gene.value, abs(comb.data) > 1.95), aes(R2,R3), method = "spearman", label.y = 20, label.x = -10, cor.coef.name = "rho")
```
...
ggplot(both.ge.z.score) + 
  ...
  theme_bw() + 
  coord_fixed(ylim = c(-10,20), xlim = c(-10,20)) +
  ylab("R2 (Gene editing efficiency z-score)") +
  xlab("R1 (Gene editing efficiency z-score")  +
  stat_cor(data = both.ge.z.score, aes(R1,R2), method = "spearman", label.y = 20, label.x = -10, cor.coef.name = "rho") +
  theme(legend.position = "none")
...
ggplot(both.ge.z.score) + 
  ...
  xlab("R1 (Gene editing efficiency z-score") +
  stat_cor(data = both.ge.z.score, aes(R1,R3), method = "spearman", label.y = 20, label.x = -10, cor.coef.name = "rho") +
  theme(legend.position = "none")
...
ggplot(both.ge.z.score) + 
  ...
  stat_cor(data = both.ge.z.score, aes(R2,R3), method = "spearman", label.y = 20, label.x = -10, cor.coef.name = "rho") +
  theme(legend.position = "none")
