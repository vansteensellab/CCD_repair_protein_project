...
ggplot(comparison.plot) + geom_quasirandom(aes(fct_reorder(perturbation, desc(class)),abs(slope.log2), color = class)) + facet_wrap(~ fct_relevel(gene,c("ATM","PARP1","ATR","PRKDC")), scales = "free_x") +
theme_bw() +
