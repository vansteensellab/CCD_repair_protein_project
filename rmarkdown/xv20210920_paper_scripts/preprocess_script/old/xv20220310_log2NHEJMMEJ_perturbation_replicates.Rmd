...
ggplot(dcast.slope.epistasis %>% filter(library == "DNA_repair"), aes(R1,R4)) + geom_point() + xlab("R1 (chromatin specific effects))") + ylab("R4 (chromatin specific effects)") + geom_abline() + theme_bw()
ggplot(dcast.slope.epistasis %>% filter(library == "DNA_repair"), aes(R4,R5)) + geom_point() + xlab("R4 (chromatin specific effects))") + ylab("R5 (chromatin specific effects)") + geom_abline() + theme_bw()
ggplot(dcast.slope.epistasis %>% filter(library == "DNA_repair"),aes(R1,R5))  + geom_point() + xlab("R1 (chromatin specific effects))") + ylab("R5 (chromatin specific effects)") + geom_abline() + theme_bw()
