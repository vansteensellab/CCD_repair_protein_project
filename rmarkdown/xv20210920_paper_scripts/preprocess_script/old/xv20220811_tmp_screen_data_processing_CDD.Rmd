...
#Transform these z-scores to p-values
p.val.z.scores.mean <- fit.z.scores.ratio.mean %>% 
  mutate(p_val = 2*pnorm(abs(mean.z.score.IPR), lower.tail = F), p_adj = p.adjust(p_val, method = "BH"))
