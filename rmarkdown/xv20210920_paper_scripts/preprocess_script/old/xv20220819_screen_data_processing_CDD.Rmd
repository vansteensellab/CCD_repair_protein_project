...
export_screen_result_TS6 <- IPR_locations %>% right_join(clone5_z.score_chrom_tib %>% filter(ID %in% barcodes.list), by = c("IPR_barcode" = "ID")) %>% select(-pool,-binsize, -clone)
```
...
saveRDS_proof(export_screen_result_TS7, file = "data/processed_data/xv20220819_Table_S7_DR_screen_results.rds")
...
write.xlsx(export_screen_result_TS7, file = "data/supplementary_tables/xv20220819_Table_S7a_global_CCD_MMEJ_NHEJ_results.xlsx")
