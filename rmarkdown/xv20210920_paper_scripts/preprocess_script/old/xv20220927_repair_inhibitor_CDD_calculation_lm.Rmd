...
saveRDS_proof(sel.inhibitor.data, file = "data/processed_data/CCD_inhibitors/xv20220927_inhibitors_repair_metrics.rds")

#Step 2: dcast data table for 
saveRDS_proof(log2.distance.ratio, file = "data/processed_data/CCD_inhibitors/xv20220927_drug_differentials_log2_MMEJ_NHEJ_balance.rds")

#Step 3: Student's t-test p-value
saveRDS_proof(significant.inh.t.test, file = "data/processed_data/CCD_inhibitors/xv20220927_drug_t_test_final_values.rds") #T-test values

#Step 4: diff log2 MMEJ:NHEJ values for DR proteins with chromatin scores
saveRDS_proof(drug.CCD.dt, file = "data/processed_data/CCD_inhibitors/xv20220927_drug_log2_MMEJNHEJ_differentials_chromatin_KO.rds")

#Step 5: save global changes for all proteins
saveRDS_proof(mean.diff.balance.export, file = "data/processed_data/CCD_inhibitors/xv20220927_drug_global_diff_MMEJNHEJ.rds")

#Final data table: Table S3
saveRDS_proof(export_screen_result_TS7, file = "data/processed_data/xv20220927_drug_CCD_results.rds")
