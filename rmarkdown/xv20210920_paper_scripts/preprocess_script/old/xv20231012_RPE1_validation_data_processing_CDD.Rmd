...
RPE1_data_chrom_tib <- readRDS_proof("/home/x.vergara/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen","chromatin_data_RPE1") %>%
  filter(cell_line == "RPE1" & binsize == 2000  & barcode != "CTTGCATTAACAACCA") #Chromatin
...
ggplot() + 
  geom_point(data = summary_table_control_plots,aes(IPR_frequency, log2((del_7 + 1) / (ins_1 + 1)), color = ins_1 > 5 & del_7 > 5)) +
  theme_bw() +
  theme(axis.title.x = element_blank()) + 
  ylab("log2MMEJ:NHEJ") +
...
saveRDS_proof(screen.data.names.tib, file = "data/processed_data/CCD_validation_RPE1/xv20231012_RPE1_screening_raw_data_repair_metrics.rds")

#Step 2: dcast data table for 
saveRDS_proof(log2.distance.ratio, file = "data/processed_data/CCD_validation_RPE1/xv20231012_RPE1_differentials_log2_MMEJ_NHEJ_balance.rds")

#Step 4: diff log2 MMEJ:NHEJ values for DR proteins with chromatin scores
saveRDS_proof(DDR.KO.CCD.dt, file = "data/processed_data/CCD_validation_RPE1/xv20231012_RPE1_log2_MMEJNHEJ_differentials_chromatin_KO.rds")

#Step 5: save global changes for all proteins
saveRDS_proof(mean.diff.balance.export, file = "data/processed_data/CCD_validation_RPE1/xv20231012_RPE1_global_diff_MMEJNHEJ.rds")

#Save final results as rds
saveRDS_proof(export_screen_result_TS7, file = "data/processed_data/xv20231012_RPE1_CCD_summary.rds")
