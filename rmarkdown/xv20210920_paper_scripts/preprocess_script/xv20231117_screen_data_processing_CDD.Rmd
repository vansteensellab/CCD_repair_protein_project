...
mean.diff.balance.export <- test.mean.diff.balance %>%
  ...
  left_join(log2.distance.ratio %>% select(gene,well,plate))
...
saveRDS_proof(export_screen_result_TS7, file = "data/processed_data/xv20231117_Table_S7_DR_screen_results.rds")
...
write.xlsx(export_screen_result_TS7, file = "data/supplementary_tables/xv20231117_Table_S7a_global_CCD_MMEJ_NHEJ_results.xlsx", keepNA = T)
