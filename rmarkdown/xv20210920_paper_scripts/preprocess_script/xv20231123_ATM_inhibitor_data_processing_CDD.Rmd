...
export_screen_result_TS4 <- log2.distance.ratio %>% 
  filter(inhibitor == "ATMi") %>%
  mutate(cell_line = case_when(cell_line == "PRO" ~ "RPE1_p53_KO",
                               cell_line == "DEF" ~ "RPE1_p53_BRCA1_dKO",
                               T ~ cell_line)) %>%
  dplyr::select(cell_line, inhibitor, IPR_barcode = "barcode", delta_log2_MMEJ_NHEJ = "mean.log2foldchange", number_replicates = "n_rep")
```
...
export_screen_result_TS7 <- pathway_summary %>%
  ...
  mutate(global_effect = case_when(global_p_adj < 0.05 & global_diff < 0 ~ "favorMMEJ",
                                   ...
                                   T ~ "none"),
         cell_line = case_when(cell_line == "DEF" ~ "RPE1_p53_BRCA1_dKO",
                               cell_line == "PRO" ~ "RPE1_p53_KO")) %>%
...
write.xlsx(export_screen_result_TS4, file = "data/supplementary_tables/xv20231123_Table_S4e_RPE1_inhibitor_delta_log2_MMEJ_NHEJ.xlsx")
