...
#DNA repair CCDs
slope.protein.features.all  <- readRDS_proof("data/processed_data","DR_KO_CCD")
...
saveRDS_proof(cluster_tibble, "data/processed_data/xv20220627_DR_CCD_cluster_data.rds")
```
