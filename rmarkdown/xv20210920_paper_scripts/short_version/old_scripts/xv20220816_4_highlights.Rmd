...
#Test wilcox_test
spo_distribution <- filter(distribution_tumor, type == "sporadic_HPVneg")
BRCA2mut_distriution <- filter(distribution_tumor, type == "BRCA2mut")

wilcox.test(spo_distribution$freq_ciLAD, BRCA2mut_distriution$freq_ciLAD)
