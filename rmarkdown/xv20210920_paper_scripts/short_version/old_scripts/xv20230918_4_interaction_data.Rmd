...
pdf("/home/x.vergara/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/figure_3_Interaction_data/xv20230918_clique_1_conservation_other_cell_lines.pdf", width = 3.5, height = 2.5)
ggplot(clique1_data %>% select(cell_line, value) %>% distinct(), aes(fct_relevel(cell_line,c("K562","DEF","PRO","RPE1")), value)) +
  ...
  theme(axis.title.x = element_blank(), legend.position = "none") + ylab("Cosine similarity score")
dev.off()
...
pdf("/home/x.vergara/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/figure_3_Interaction_data/xv20230918_clique_FA_conservation_other_cell_lines.pdf", width = 3.5, height = 2.5)
...
pdf("/home/x.vergara/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/figure_3_Interaction_data/xv20230918_mixed_clique_conservation_other_cell_lines.pdf", width = 3.5, height = 2.5)
