...
Figure 3a: Global ∆log2MMEJ:NHEJ score correlation in K562 and RPE1p53KO
...
#Calculate all possible cosine similarities
```{r, message=F}
...
#Cosine similarity calculation RPE1 p53KO cells
...
# Calculate for RPE1 p53/BRCA1 KO cells
```{r,fig.width=5,fig.height=3}
...
#Cosine similarity distribution in RPE1 p5KO cells
...
#Plot cosine similarities RPE1 p53KO cells (Figure 3D)
...
#Compute distribution of cosine similarities for plot Fig 4D
#Cosine similarity distribution in RPE1 p53/BRCA1 KO cells
```{r, message = F, warning = F}
#Sampling loop to select random samples of equal size as interacting pairs
...
#Plot cosine similarities RPE1 p53/BRAC1 KO cells
...
#Figure 3E: Cosine distance calculations (RPE1 p53KO) & K562)
```{r}
...
#Figure 3F: Cosine distance calculations (RPE1 p53/BRCA1dKO & K562)
```{r}
