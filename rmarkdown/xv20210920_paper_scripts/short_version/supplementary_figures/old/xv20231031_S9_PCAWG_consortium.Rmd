...
#Plot
pdf(file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/supplementary_figures/fiigure_S8_tumor_analysis/xv20231117_S8A_tumor_counts.pdf", width = 5, height = 4)
...
#Plot differences
pdf(file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/supplementary_figures/fiigure_S8_tumor_analysis/xv20231117_S9B_control_tissue_type.pdf", width=4,height=3.5)
...
pdf(file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/supplementary_figures/fiigure_S8_tumor_analysis/xv20231117_S8C_distribution_per_tissue.pdf", width = 7, height = 6)
ggplot(boot_matched_distribution %>% right_join(combinations_to_plot), aes(project,bias)) + 
  ...
  facet_wrap(~ fct_relevel(driver, c("ATM","ATRX","EGFR","SETD2","MEN1","BRCA2","BRCA1","TRRAP")), scales = "free", ncol = 4) +
  theme(axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5),
        panel.grid = element_blank(),
        legend.position = "top")
dev.off()
...
pdf(file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20220117_paper_figure_short/supplementary_figures/fiigure_S8_tumor_analysis/xv20231117_S8C_total_indel_accumulation.pdf", width = 3, height = 4)
