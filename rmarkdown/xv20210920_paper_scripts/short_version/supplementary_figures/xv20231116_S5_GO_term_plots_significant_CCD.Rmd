...
# Script to generate figure Supplementary #5 in the paper.
...
#Figure S5A GO:0006303 = double-strand break repair involved in non-homologous end joining
...
#Figure S5B GO:0000729 = DNA double-strand break processing
```{r Fig_2_D, warning=FALSE, message=FALSE, fig.width=5, fig.height=4}
# Separate data based on the significant IPRs that they have (based on z-score)
...
# Figure S5C GO:0045002 = double-strnad break repair by single-strand annealing
```{r Fig_2_D, warning=FALSE, message=FALSE}
# Separate data based on the significant IPRs that they have (based on z-score)
...
# Figure S5D GO:1990918 = double-strand break repair involved in meiotic recombination
```{r Fig_2_D, warning=FALSE, message=FALSE}
# Separate data based on the significant IPRs that they have (based on z-score)
...
# Figure S5E GO:0000724 = double-strand break repair involved in homologus recombination
```{r Fig_2_D, warning=FALSE, message=FALSE}
# Separate data based on the significant IPRs that they have (based on z-score)
