...
#Figure S7C-D: Compare the effect sizes. C is global differences and D is CCDs
...
E) Editing frequency estimation by TIDE in transfection controls at Day 1 (first transfection) and Day 6 (second transfection).

F) Editing frequency in transcribed IPRs in clone 5. We classified IPRs based on the transcription-related feature signals.
...
# Figure S7G-H: Drug treatment effect sizes
```{r}
