---
title: "xv20240425_5_ATM_BRCA1_effect"
author: "x.vergara"
...
# Script to generate figure 5 in the paper.
...
```
(A-B) Global effect measured as ∆log2MMEJ:NHEJ scores in RPE-1 p53KO and p53/BRCA1dKO cells after (A) ATM KO and (B) ATM inhibition. P-value shown in parentheses are according to two-sided Student’s t-test.

# Figure 5C-D
```{r, fig.width=4.5, fig.height=2, warning=FALSE, message=FALSE}
...
```
(C-D) Heterochromatin CCD effect measured as the estimated ∆log2MMEJ:NHEJ for every heterochromatic feature after (C) ATM KO and (D) ATM inhibition. P-value shown in parentheses are according to two-sided paired Student’s t-test.
