...
ggplot(boot_strap_total_rough) + 
  geom_quasirandom(aes(driver,min_indel)) + 
  theme_bw() + geom_point(data = mutant_bias, aes(driver,min_indel), color = "blue", size = 4)

#ggplot difference densities
ggplot(boot_strap_total_rough) + 
  geom_quasirandom(aes(driver,global_bal)) + 
  theme_bw() + geom_point(data = total_changes_indels %>% filter(sample == "control"), aes(driver,global_bal), color = "red", size = 3)

#ggplot difference densities
ggplot(boot_strap_total_rough) + 
  geom_quasirandom(aes(driver,bias)) + 
  theme_bw() + geom_point(data = total_changes_indels %>% filter(sample == "control"), aes(driver,bias), color = "red", size = 3)
