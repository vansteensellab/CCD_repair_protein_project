...
#Conclusion: To get high reproducibility in the results, we really need to be very stringent with the cut-off. I think the total number of read cutoff doesn't work as nicely as the enough reads on both.
