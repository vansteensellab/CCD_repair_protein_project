...
values_chromatin_U2OS <- left_join(high_confidence_IPR, chromatin_pools_binsize)
...
write_rds(chromatin_pools_binsize, file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/pools_balance/xv20230814_chromatin_features_zscore_U2OS.rds")
```
