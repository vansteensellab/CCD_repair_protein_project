...
#ATM example
human_gRNA <- read.delim(file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_library/indelphi_human/BRCA2_hg38.csv", sep = ",")

mouse_gRNA <- read.delim(file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_library/indelphi_mouse/BRCA2_mm10.csv", sep = ",")
