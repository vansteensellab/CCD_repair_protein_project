...
#Export data table
```{r}
write_rds(drug_CCD_all_values, file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230912_CCD_analysis_summary_DEF_all_viable_3reps.rds") #In this data, all toxic KO are kept as well

#Export log2 balances
write_rds(inhibitor_effect_chromatin_RPE1, file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230911_log2_balance_chromatin_DEF_all.rds") #In this data, all toxic KO are kept as well
