...
high_confidence_IPR <- readRDS("~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230912b_PRO_viable_mean_freq_0.0025.rds") %>% filter(is.finite(log2_bal))
...
#Export data table
```{r}
write_rds(drug_CCD_all_values, file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230912_CCD_analysis_summary_PRO_freq_0.0025_n3.rds")
