...
high_confidence_IPR <- readRDS("~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230915_PRO_all_mean_freq_0.0025.rds") %>% filter(is.finite(log2_bal))
...
spearman_coefficients <- map_dfr(unique(average_log2_balance$gRNA), function(x){
  ...
  rho_table %>% mutate(cell_line = "PRO", binsize = y) %>% distinct()
  })
})
...
```
#Plot only binsize 2000
```{r, fig.width=3.5,fig.height=4}
#Plot correlation coefficients
pdf("/home/x.vergara/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/export/xv20230307_revision_figures/RPE_PRO_DEF/xv20230918_PRO_chromatin_correlation.pdf", width = 3.5,height = 4)
...
#Export data table
```{r}
write_rds(drug_CCD_all_values, file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230915_CCD_analysis_summary_PRO_freq_0.0025_n3.rds")

#Export log2 balances
write_rds(inhibitor_effect_chromatin_RPE1, file = "~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230912_log2_balance_chromatin_PRO.rds")
