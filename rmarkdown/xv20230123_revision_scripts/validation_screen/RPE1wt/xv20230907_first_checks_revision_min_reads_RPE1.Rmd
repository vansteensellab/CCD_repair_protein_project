...
read_count <- c(0,0.001,0.002,0.004,0.008,0.01)
...
#R1 vs. R2
ggplot(read_counts_filter_reprod_summary %>% filter(read_filter == "0.008" & reps == 3), aes(R1,R2)) +
  geom_point() + 
...
#R1 vs. R2
ggplot(read_counts_filter_reprod_summary  %>% filter(read_filter == "0.008" & reps == 3), aes(R2,R3)) +
  geom_point() + 
  geom_smooth(method = "lm") +
  ggpubr::stat_cor() +
  theme_bw()
...
#R1 vs. R2
ggplot(read_counts_filter_reprod_summary %>% filter(read_filter == "0.008" & reps == 3), aes(R1,R3)) +
  geom_point() + 
  geom_smooth(method = "lm") +
  ggpubr::stat_cor() +
