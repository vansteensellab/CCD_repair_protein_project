...
high_confidence_IPR <- readRDS("~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230905_PRO_DEF_pathway_balance_5reads_per_indel.rds") %>% 
...
ggplot(inhibitor_effect_chromatin_RPE1 %>% filter(gRNA %in% prots_with_8_IPR & binsize == "2000"), aes(chip_H3K4me1,mean_diff)) + 
     geom_point() + 
     geom_smooth(method = "lm", se = F) + 
     ggpubr::stat_cor(method = "pearson") +
     facet_grid(cell_line ~ gRNA)+ theme_bw()
