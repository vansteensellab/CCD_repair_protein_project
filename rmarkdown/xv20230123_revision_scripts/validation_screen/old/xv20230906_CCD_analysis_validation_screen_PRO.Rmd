...
high_confidence_IPR <- readRDS("~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230905_PRO_pathway_bal_only_R3.rds") %>% 
...
for (j in unique(pca_model_dt$cell_line)){
  ...
  for (i in unique(cell_line_df$gRNA)){
    ...
    set.seed(1)
    PCR_model_DDR_test <- pls::pcr(mean_diff~ dam_H3K27me3+chip_H3K36me3+dam_LMNB1+chip_H3K4me1+chip_H3K4me2+chip_H3K4me3+chip_H3K27ac+dam_H3K9me2+dam_H3K9me3+late_replicating, data=gene.library.dt, validation = "CV") #Run principal component regression
