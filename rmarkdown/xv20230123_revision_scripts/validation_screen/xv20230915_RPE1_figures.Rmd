...
RPE1_K562_CCD <- bind_rows(K562_CCD, RPE1_CCD, PRO_CCD)
...
#All log2_values
RPE1_log2 <- readRDS("~/XV_P3_ChromDSBScreen/xv_CRISPR_screen_figures/data/revisions/validation_screen/xv20230912_log2_balance_chromatin_RPE1_5reads.rds") %>% left_join(proteins_gRNA)
...
RPE1_K562_CCD_dcast <- RPE1_K562_CCD %>% 
  select(gene,global_diff,cell_line) %>%
  distinct() %>%
...
ggplot(RPE1_K562_CCD_dcast, aes(RPE1, PRO)) + 
  geom_point() +
  ggpubr::stat_cor(method = "spearman") + 
  geom_smooth(method = "lm", se = F) +
  geom_abline(linetype = 2) +
  theme_bw() + 
  coord_fixed() + xlab("∆log2 MMEJ::NHEJ (RPE1-hTERT)") +
  ylab("∆log2 MMEJ::NHEJ (RPE1-hTERT p53KO)") +
